...
struct tagAddImage
{
	...
	void addImage_Func()
	{
		...
		// Effact Image
		IMAGEMANAGER->addFrameImage("Smork", "./image/Effact/Smork.bmp", 2964, 58, 26, 1, true, RGB(255, 0, 255));		// 대쉬 이펙트 

		// skul Image adddddddddd  튜토리얼 이미지 0 ~ 3 , 머리 있는 스컬 이미지 4 ~ 9 , 머리 없는 스컬 이미지 
